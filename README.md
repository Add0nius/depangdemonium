# DEPANGDEMONIUM
🔥 Depangdemonium is pure gameplay.
🚫 No menus.
🚫 No tutorials.
🚫 No waiting.
🚫 No ending.
🖱️ You click and you’re in.
⚪⚪ → 🧙‍♂️ → ⚪⚪💥⚪ → ⚪💥 → 💥✨
👁️ Welcome to Depangdemonium.
FREE for PC & Android. See more in [license.txt](license.txt) file. See ["Releases"](https://github.com/Add0nius/depangdemonium/releases) section in GitHub repository to download the installables. Links:
